...
export const T = {
  en: {
    ...
    hero_desc:  'A historic first — the newly installed Mahamandaleshwar\'s first official journey to Europe. <strong>Sri Sri 1008 Mahamandaleshwar Karauli Shankar Mahadev Maharaj</strong> brings the authentic Indian contemplative tradition to Central Europe for the first time — Czech Republic, May 2027. <strong>Register your interest →</strong>',
    scroll:     'Scroll',
  ...
  cs: {
    ...
    hero_desc:  'Historicky první oficiální evropská cesta nově uvedeného Mahámandaléšvary. <strong>Sri Sri 1008 Mahámandaléšvar Karauli Shankar Mahadev Maharaj</strong> poprvé přináší autentickou indickou kontemplativní tradici do střední Evropy — Česká republika, květen 2027. <strong>Registrovat zájem →</strong>',
    scroll:     'Scrollovat',
  ...
  hi: {
    ...
    hero_desc:  'एक ऐतिहासिक पहली बार — नवनियुक्त महामंडलेश्वर की यूरोप की पहली आधिकारिक यात्रा। <strong>श्री श्री 1008 महामंडलेश्वर करौली शंकर महादेव महाराज</strong> पहली बार भारत की प्रामाणिक चिंतनशील परंपरा को मध्य यूरोप में ला रहे हैं — चेक गणराज्य, मई 2027। <strong>अपनी रुचि दर्ज करें →</strong>',
    scroll:     'स्क्रॉल',
  ...
  fr: {
    ...
    hero_desc:  'Un événement historique — le premier voyage officiel en Europe du Mahamandaleshwar nouvellement intronisé. <strong>Sri Sri 1008 Mahamandaleshwar Karauli Shankar Mahadev Maharaj</strong> apporte pour la première fois la tradition contemplative indienne authentique en Europe centrale — République tchèque, mai 2027. <strong>Manifester votre intérêt →</strong>',
    scroll:     'Défiler',
  ...
  es: {
    ...
    hero_desc:  'Un hito histórico — el primer viaje oficial a Europa del Mahamandaleshwar recién instalado. <strong>Sri Sri 1008 Mahamandaleshwar Karauli Shankar Mahadev Maharaj</strong> trae por primera vez la auténtica tradición contemplativa india a Europa Central — República Checa, mayo de 2027. <strong>Registrar interés →</strong>',
    scroll:     'Desplazar',
  ...
  de: {
    ...
    hero_desc:  'Ein historischer Moment — die erste offizielle Europareise des neu eingesetzten Mahamandaleshwar. <strong>Sri Sri 1008 Mahamandaleshwar Karauli Shankar Mahadev Maharaj</strong> bringt die authentische indische kontemplative Tradition zum ersten Mal nach Mitteleuropa — Tschechische Republik, Mai 2027. <strong>Interesse anmelden →</strong>',
    scroll:     'Scrollen',
