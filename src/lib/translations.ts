...
export const T = {
  en: {
    ...
    hero_desc:  'A historic first for Europe. <strong>Sri Sri 1008 Mahamandaleshwar Karauli Shankar Mahadev Maharaj</strong> brings the authentic Indian contemplative tradition to Central Europe for the first time — Czech Republic, May 2027.',
    scroll:     'Scroll',
    ...
    india_label: 'Beyond the Journey',
    india_title: 'Stories, wisdom &<br><span class="acc">moments from India</span>',
    ...
    india_p1: 'More than a journey through places — an exploration of wisdom, practice and the people we meet along the way.',
  ...
  cs: {
    ...
    india_label: 'Víc než cesta',
    india_title: 'Příběhy, moudrost a<br><span class="acc">okamžiky z Indie</span>',
    ...
    india_p1: 'Víc než cesta po místech — objevování moudrosti, praxe a lidí, které na cestě potkáváme.',
  ...
  hi: {
    ...
    india_label: 'यात्रा से परे',
    india_title: 'कहानियाँ, ज्ञान और<br><span class="acc">भारत के क्षण</span>',
    ...
    india_p1: 'यह केवल स्थानों की यात्रा नहीं है — यह ज्ञान, अभ्यास और उन लोगों की खोज है, जिनसे हम राह में मिलते हैं।',
  ...
  fr: {
    ...
    india_label: 'Au-delà du voyage',
    india_title: 'Histoires, sagesse et<br><span class="acc">instants venus d’Inde</span>',
    ...
    india_p1: 'Plus qu’un simple voyage à travers des lieux — une exploration de la sagesse, de la pratique et des personnes que nous rencontrons en chemin.',
  ...
  es: {
    ...
    india_label: 'Más allá del viaje',
    india_title: 'Historias, sabiduría y<br><span class="acc">momentos de la India</span>',
    ...
    india_p1: 'Más que un viaje por lugares — una exploración de la sabiduría, la práctica y las personas que encontramos en el camino.',
  ...
  de: {
    ...
    india_label: 'Mehr als eine Reise',
    india_title: 'Geschichten, Weisheit und<br><span class="acc">Momente aus Indien</span>',
    ...
    india_p1: 'Mehr als eine Reise durch Orte — eine Erkundung von Weisheit, Praxis und den Menschen, denen wir unterwegs begegnen.',
