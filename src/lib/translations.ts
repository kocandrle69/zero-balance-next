...
export const T = {
  en: {
    ...
    nav_media: 'Media',
    nav_journal:    'Journal',
    nav_join:       'Join the Society today',
    ...
    about_p1:    'Zero Balance Society is a non-profit cultural association rooted in the spiritual traditions of India — the lineage and teachings of Shri Karauli Shankar Mahadeva Ji, recognised in the distinguished rank of Mahāmaṇḍalēśvar of Shri Panchayati Akhada Naya Udasin Nirvan.',
    about_p2:    'We create space for spiritual practice, personal growth, education, cultural exchange and international cooperation. Our work is entirely non-commercial — all resources serve the mission of the association and its community.',
    about_v1:    'Supporting and preserving Vedic, yogic and tantric traditions',
    about_v2:    'Fostering spiritual practice, meditation and personal growth',
    about_v3:    'Building bridges between cultures through shared experience',
    about_v4:    'Non-profit — all resources serve the mission of the association',
  ...
  cs: {
    ...
    about_p1:    'Zero Balance Society je nezisková kulturní asociace zakotvená v duchovních tradicích Indie — v linii a učení Shri Karauli Shankar Mahadeva Ji, slavnostně potvrzeného ve významné duchovní hodnosti Mahámandaléšvar Shri Panchayati Akhada Naya Udasin Nirvan.',
    about_p2:    'Vytváříme prostor pro duchovní praxi, osobní rozvoj, vzdělávání, kulturní a mezikulturní výměnu a mezinárodní spolupráci. Naše činnost je zcela nezisková — veškeré prostředky slouží poslání spolku a jeho komunitě.',
    about_v1:    'Podpora a uchovávání védských, jógových a tantrických tradic',
    about_v2:    'Duchovní praxe, meditace a osobní rozvoj',
    about_v3:    'Budování mostů mezi kulturami skrze sdílenou zkušenost',
    about_v4:    'Nezisková organizace — vše slouží poslání spolku',
