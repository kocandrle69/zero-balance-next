        ...
        <article className={styles.article} style={{ paddingTop: '120px', position: 'relative' }}>
          ...
          <section className={styles.section}>
            <div className={styles.personRow}>
              <div className={styles.personImg}>
                <img src="/images/Jan.png" alt="Jan Kočandrle" style={{ objectPosition: '75% 25%' }} />
              </div>
          ...
          <section className={styles.section}>
            <div className={`${styles.personRow} ${styles.personRowReverse}`}>
              <div className={styles.personImg}>
                <img src="/images/Gurudev.png" alt="Gurudev Shri Karauli Shankar Mahadeva Ji" style={{ objectPosition: '75% 15%' }} />
              </div>
              <div className={styles.personText}>
          ...
          <section className={styles.section}>
            <div className={styles.personRow}>
              <div className={styles.personImg}>
                <img src="/images/Sensei 3.png" alt="Rajeev Sinha — Sensei" style={{ objectPosition: '85% 10%', transform: 'scale(1.4)' }} />
              </div>
              <div className={styles.personText}>
