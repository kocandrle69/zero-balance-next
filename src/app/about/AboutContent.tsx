        ...
        <article className={styles.article} style={{ paddingTop: '120px' }}>
          ...
          <section className={styles.section}>
            <div className={styles.personRow}>
              <div className={styles.personImg}>
                <img src="/images/Jan.png" alt="Jan Kočandrle" />
              </div>
          ...
          <section className={styles.section}>
            <div className={`${styles.personRow} ${styles.personRowReverse}`}>
              <div className={styles.personImg}>
                <img src="/images/Gurudev.png" alt="Gurudev Shri Karauli Shankar Mahadeva Ji" />
              </div>
              <div className={styles.personText}>
          ...
          <section className={styles.section}>
            <div className={styles.personRow}>
              <div className={styles.personImg}>
                <img src="/images/Sensei 3.png" alt="Rajeev Sinha — Sensei" />
              </div>
              <div className={styles.personText}>
