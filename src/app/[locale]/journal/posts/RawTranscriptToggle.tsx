 ...
 * apply to the polished article body above this, not to this appendix.
 */
const RAW_HI = `
OTHER SPEAKER:
...
const TURNS = parseTranscript(RAW_HI)

const UI = {
  cs: { show: 'Zobrazit původní přepis', hide: 'Skrýt původní přepis' },
  en: { show: 'Show original transcript', hide: 'Hide original transcript' },
  hi: { show: 'मूल प्रतिलेख देखें', hide: 'मूल प्रतिलेख छुपाएँ' },
  fr: { show: 'Afficher la transcription originale', hide: 'Masquer la transcription originale' },
  es: { show: 'Mostrar transcripción original', hide: 'Ocultar transcripción original' },
  de: { show: 'Original-Transkript anzeigen', hide: 'Original-Transkript ausblenden' },
} as const
  ...
  return (
    <div className={styles.transcriptWrap}>
      ...
      >
        ...
        <span className={open ? styles.transcriptArrowOpen : styles.transcriptArrow}>↓</span>
      </button>

      <div className={`${styles.transcriptPanel} ${open ? styles.transcriptPanelOpen : ''}`}>
        <div className={styles.transcriptInner}>
          <div className={styles.transcriptBadge}>Raw transcript · Hindi</div>
