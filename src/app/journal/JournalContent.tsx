...
const CONTENT = {
  cs: {
    ...
    members: [
      ...
      { initial: 'F', role: 'Místopředseda spolku',   name: 'Ing. František Filouš',       bio: 'Zakladatel spolku a člen Zero Balance Society.', photo: '/images/Franta.png', imgPos: '40% 20%' },
      { initial: 'P', role: 'Zakládající člen',        name: 'Pavel Znamenáček',       bio: 'Člen Zero Balance Society.', photo: '/images/Pavel.png', imgPos: '70% 20%' },
      { initial: 'P', role: 'Zakládající členka',      name: 'Pavlína Muchová',        bio: 'Členka Zero Balance Society.', photo: '/images/Pavlina.png', imgPos: '60% 15%', imgScale: '1.2' },
    ],
  ...
  en: {
    ...
    members: [
      ...
      { initial: 'F', role: 'Vice-Chairman',            name: 'Ing. František Filouš',       bio: 'Founder and member of Zero Balance Society.', photo: '/images/Franta.png', imgPos: '40% 20%' },
      { initial: 'P', role: 'Founding Member',          name: 'Pavel Znamenáček',       bio: 'Member of Zero Balance Society.', photo: '/images/Pavel.png', imgPos: '70% 20%' },
      { initial: 'P', role: 'Founding Member',          name: 'Pavlína Muchová',        bio: 'Member of Zero Balance Society.', photo: '/images/Pavlina.png', imgPos: '60% 15%', imgScale: '1.2' },
    ],
  ...
  hi: {
    ...
    members: [
      ...
      { initial: 'F', role: 'उपाध्यक्ष',                    name: 'Ing. František Filouš',       bio: 'Zero Balance Society के संस्थापक और सदस्य।', photo: '/images/Franta.png', imgPos: '40% 20%' },
      { initial: 'P', role: 'संस्थापक सदस्य',               name: 'Pavel Znamenáček',       bio: 'Zero Balance Society के सदस्य।', photo: '/images/Pavel.png', imgPos: '70% 20%' },
      { initial: 'P', role: 'संस्थापक सदस्या',              name: 'Pavlína Muchová',        bio: 'Zero Balance Society की सदस्या।', photo: '/images/Pavlina.png', imgPos: '60% 15%', imgScale: '1.2' },
    ],
