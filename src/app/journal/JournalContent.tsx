...
const CONTENT = {
  cs: {
    ...
    members: [
      ...
      { initial: 'P', role: 'Spoluzakládající člen', name: 'Pavel Znamenáček', bio: 'Spoluzakládající člen Zero Balance Society. Vynikající karatista a trenér, který se již více než 30 let věnuje práci s mládeží a vede úspěšný oddíl karate. Právě prostřednictvím jeho karatistického oddílu se zakladatelé spolku před více než 20 lety poprvé setkali se Senseiem Rajeevem Sinhou. Ve spolku se Pavel podílí především na organizačních a technických záležitostech.', photo: '/images/Pavel.jpg', imgPos: '70% 20%' },
    ],
  ...
  en: {
    ...
    members: [
      ...
      { initial: 'P', role: 'Co-founding Member', name: 'Pavel Znamenáček', bio: 'Co-founding member of Zero Balance Society. An accomplished karateka and coach who has worked with young people for over 30 years, leading a successful karate club. It was through his club that the founders of the association first met Sensei Rajeev Sinha more than twenty years ago. Within the association, Pavel focuses primarily on organisational and technical matters.', photo: '/images/Pavel.jpg', imgPos: '70% 20%' },
    ],
  ...
  hi: {
    ...
    members: [
      ...
      { initial: 'P', role: 'सह-संस्थापक सदस्य', name: 'Pavel Znamenáček', bio: 'Zero Balance Society के सह-संस्थापक सदस्य। एक कुशल कराटे खिलाड़ी और प्रशिक्षक, जो 30 से अधिक वर्षों से युवाओं के साथ कार्य करते हैं और एक सफल कराटे क्लब का नेतृत्व करते हैं। यह उन्हीं के कराटे क्लब के माध्यम से था कि संस्था के संस्थापकों की बीस से अधिक वर्ष पहले सेंसेई राजीव सिन्हा से पहली मुलाकात हुई। संस्था में पावेल मुख्यतः संगठनात्मक और तकनीकी मामलों में योगदान करते हैं।', photo: '/images/Pavel.jpg', imgPos: '70% 20%' },
    ],
