...
const CONTENT = {
  cs: {
    ...
    members: [
      { initial: 'S', role: 'Čestný předseda spolku', name: 'Sensei Rajeev Sinha', bio: 'Čestný předseda Zero Balance Society, jogínský mistr a učitel Tantra Kriya Yogy s žáky po celém světě. Členy spolku již více než dvacet let osobně vede v praxi původní indické duchovní tradice.', photo: '/images/Sensei4.jpg', imgPos: 'center 15%', email: 'senseirajeev@icloud.com' },
      { initial: 'J', role: 'Předseda spolku', name: 'Jan Kočandrle', bio: 'Zakladatel a předseda Zero Balance Society. Podílí se na rozvoji činnosti spolku, jeho kulturní misi a na vytváření prostoru pro setkávání, studium a sdílení indických duchovních tradic.', photo: '/images/Jan2.png', imgPos: '55% 20%', email: 'jan@zero-balance.org' },
      { initial: 'J', role: 'Místopředseda spolku', name: 'PhDr. Jiří Kočandrle', bio: 'Místopředseda Zero Balance Society. Věnuje se komunikaci, vztahům s veřejností a rozvoji kulturní mise spolku. Podílí se na předávání jogínské praxe a podpoře studia indických duchovních tradic.', photo: '/images/Jiri3.png', imgPos: '65% 20%', email: 'jiri@zero-balance.org' },
      { initial: 'F', role: 'Místopředseda spolku', name: 'Ing. František Filouš', bio: 'Místopředseda spolku. Věnuje se legislativním a technickým záležitostem a podílí se na praktickém fungování Zero Balance Society.', photo: '/images/Franta2.png', imgPos: '62% 15%' },
      { initial: 'P', role: 'Spoluzakládající členka', name: 'Pavlína Muchová', bio: 'Spoluzakládající členka Zero Balance Society. Do činnosti spolku přináší cit pro krásu, tvořivost a výtvarné vnímání; věnuje se malbě a podporuje kulturní a umělecký rozměr našich aktivit.', photo: '/images/Pavlina2.png', imgPos: '62% 15%' },
      { initial: 'P', role: 'Spoluzakládající člen', name: 'Pavel Znamenáček', bio: 'Spoluzakládající člen Zero Balance Society. Vynikající karatista a trenér, který se více než 30 let věnuje práci s mládeží a vede úspěšný oddíl karate. Právě díky jeho oddílu se zakladatelé spolku před více než 20 lety poprvé setkali se Senseiem Rajeevem Sinhou. Ve spolku se podílí především na organizačních a technických záležitostech.', photo: '/images/Pavel2.png', imgPos: '62% 15%' },
    ],
  ...
  en: {
    ...
    members: [
      ...
      { initial: 'J', role: 'Chairman', name: 'Jan Kočandrle', bio: 'Founder and Chairman of Zero Balance Society. He contributes to the development of the association\'s activities, its cultural mission and the creation of spaces for gathering, study and sharing of Indian spiritual traditions.', photo: '/images/Jan2.png', imgPos: '55% 20%', email: 'jan@zero-balance.org' },
      { initial: 'J', role: 'Vice-Chairman', name: 'PhDr. Jiří Kočandrle', bio: 'Vice-Chairman of Zero Balance Society. He focuses on communication, public relations and the development of the association\'s cultural mission, and contributes to the transmission of yogic practice and the study of Indian spiritual traditions.', photo: '/images/Jiri3.png', imgPos: '65% 20%', email: 'jiri@zero-balance.org' },
      { initial: 'F', role: 'Vice-Chairman', name: 'Ing. František Filouš', bio: 'Vice-Chairman of the association. He handles legislative and technical matters and contributes to the practical functioning of Zero Balance Society.', photo: '/images/Franta2.png', imgPos: '62% 15%' },
      { initial: 'P', role: 'Co-founding Member', name: 'Pavlína Muchová', bio: 'Co-founding member of Zero Balance Society. She brings a sense of beauty, creativity and artistic sensibility to the association\'s work; she is a painter and supports the cultural and artistic dimension of our activities.', photo: '/images/Pavlina2.png', imgPos: '62% 15%' },
      { initial: 'P', role: 'Co-founding Member', name: 'Pavel Znamenáček', bio: 'Co-founding member of Zero Balance Society. An accomplished karateka and coach, dedicated to working with young people for over 30 years, leading a successful karate club. It was through his club that the founders of the association first met Sensei Rajeev Sinha more than twenty years ago. Within the association he focuses primarily on organisational and technical matters.', photo: '/images/Pavel2.png', imgPos: '62% 15%' },
    ],
  ...
  hi: {
    ...
    members: [
      ...
      { initial: 'J', role: 'अध्यक्ष', name: 'Jan Kočandrle', bio: 'Zero Balance Society के संस्थापक और अध्यक्ष। वे संस्था की गतिविधियों, उसकी सांस्कृतिक मिशन और भारतीय आध्यात्मिक परंपराओं के मिलन, अध्ययन व साझाकरण के लिए स्थान निर्माण में योगदान करते हैं।', photo: '/images/Jan2.png', imgPos: '55% 20%', email: 'jan@zero-balance.org' },
      { initial: 'J', role: 'उपाध्यक्ष', name: 'PhDr. Jiří Kočandrle', bio: 'Zero Balance Society के उपाध्यक्ष। वे संचार, जनसंपर्क और संस्था की सांस्कृतिक मिशन के विकास पर ध्यान देते हैं, और योगाभ्यास के प्रसार तथा भारतीय आध्यात्मिक परंपराओं के अध्ययन में सहयोग करते हैं।', photo: '/images/Jiri3.png', imgPos: '65% 20%', email: 'jiri@zero-balance.org' },
      { initial: 'F', role: 'उपाध्यक्ष', name: 'Ing. František Filouš', bio: 'संस्था के उपाध्यक्ष। वे विधायी और तकनीकी मामलों को संभालते हैं और Zero Balance Society के व्यावहारिक संचालन में योगदान करते हैं।', photo: '/images/Franta2.png', imgPos: '62% 15%' },
      { initial: 'P', role: 'सह-संस्थापक सदस्या', name: 'Pavlína Muchová', bio: 'Zero Balance Society की सह-संस्थापक सदस्या। वे संस्था के कार्य में सौंदर्यबोध, रचनात्मकता और कलात्मक दृष्टि लाती हैं; वे एक चित्रकार हैं और हमारी गतिविधियों के सांस्कृतिक एवं कलात्मक आयाम का समर्थन करती हैं।', photo: '/images/Pavlina2.png', imgPos: '62% 15%' },
      { initial: 'P', role: 'सह-संस्थापक सदस्य', name: 'Pavel Znamenáček', bio: 'Zero Balance Society के सह-संस्थापक सदस्य। एक कुशल कराटे खिलाड़ी और प्रशिक्षक, जो 30 से अधिक वर्षों से युवाओं के साथ कार्य करते हुए एक सफल कराटे क्लब का नेतृत्व करते हैं। उन्हीं के क्लब के माध्यम से संस्था के संस्थापकों की बीस से अधिक वर्ष पहले सेंसेई राजीव सिन्हा से पहली मुलाकात हुई। संस्था में वे मुख्यतः संगठनात्मक और तकनीकी मामलों में योगदान करते हैं।', photo: '/images/Pavel2.png', imgPos: '62% 15%' },
    ],
