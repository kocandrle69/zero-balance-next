...
const CONTENT = {
  cs: {
    ...
    members: [
      { initial: 'S', role: 'Čestný předseda spolku', name: 'Sensei Rajeev Sinha', bio: 'Čestný předseda Zero Balance Society, jogínský mistr a učitel Tantra Kriya Yogy s žáky po celém světě. Členy spolku již více než dvacet let osobně vede v praxi původní indické duchovní tradice.', photo: '/images/Sensei_3.jpg', imgPos: 'center 15%' },
